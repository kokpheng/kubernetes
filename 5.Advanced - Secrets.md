...
![](Advanced - Secrets.assets/Advanced - Secrets-63301a10.png)
...
![](Advanced - Secrets.assets/Advanced - Secrets-20ea248c.png)
...
![](Advanced - Secrets.assets/Advanced - Secrets-e756cd9e.png)
...
Let’s have a look at the correct part of the [`mysql-deployment.yaml`](Source%20Code/Advanced%20Kubernetes%20Usage/Secrets/mysql-deployment.yaml) file that we used to set up MySQL. This should look familiar.

![](Advanced - Secrets.assets/Advanced - Secrets-732c9c44.png)
...
We'll make the exact same changes to the [`wordpress-deployment.yaml`](Source%20Code/Advanced%20Kubernetes%20Usage/Secrets/wordpress-deployment.yaml) file.

![](Advanced - Secrets.assets/Advanced - Secrets-2eb31f66.png)
...
![](Advanced - Secrets.assets/Advanced - Secrets-0ac97312.png)
...
kubectl get secret
```
![](Advanced - Secrets.assets/Advanced - Secrets-4303fc2b.png)
...
```
![](Advanced - Secrets.assets/Advanced - Secrets-5a8d871b.png)
...
```
![](Advanced - Secrets.assets/Advanced - Secrets-71500102.png)
...
```
![](Advanced - Secrets.assets/Advanced - Secrets-17728d99.png)
...
```
![](Advanced - Secrets.assets/Advanced - Secrets-58aa3973.png)
